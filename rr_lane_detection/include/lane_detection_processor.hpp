...
class lane_detection_processor
{
  private:
    ...
    cv::Scalar bounds_;
    cv::Mat multibounds_;
    //cv::cuda::GpuMat gpu_multibounds_;
    cv::Mat Im1_HSV_, Im1_HSV_warped_, mask_warped_1_,mask_warped_2_, mask_;
    cv::cuda::GpuMat gpu_Im1_HSV_, gpu_Im1_HSV_warped_, gpu_mask_warped_1_, gpu_mask_warped_2_, gpu_mask_;
    ...
    cv::cuda::GpuMat gpu_transform_matrix_;
    cv::Size BEV_size_;
