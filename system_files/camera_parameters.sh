...
v4l2-ctl -d /dev/cam_left -c brightness=128
v4l2-ctl -d /dev/cam_left -c contrast=32
v4l2-ctl -d /dev/cam_left -c saturation=28
v4l2-ctl -d /dev/cam_left -c white_balance_temperature_auto=0
v4l2-ctl -d /dev/cam_left -c gain=54
v4l2-ctl -d /dev/cam_left -c sharpness=223
v4l2-ctl -d /dev/cam_left -c backlight_compensation=1
v4l2-ctl -d /dev/cam_left -c exposure_auto=1
...
v4l2-ctl -d /dev/cam_right -c brightness=128
v4l2-ctl -d /dev/cam_right -c contrast=64
v4l2-ctl -d /dev/cam_right -c saturation=28
v4l2-ctl -d /dev/cam_right -c white_balance_temperature_auto=0
v4l2-ctl -d /dev/cam_right -c gain=54
v4l2-ctl -d /dev/cam_right -c sharpness=191
v4l2-ctl -d /dev/cam_right -c backlight_compensation=1
v4l2-ctl -d /dev/cam_right -c exposure_auto=1
